...
type TableColumn<Company> = {
  title: string;
  field: keyof Company;
  Cell?({ entry }: { entry: Company }): React.ReactElement;
};

export type TableProps<Company> = {
  data: Company[];
  columns: TableColumn<Company>[];
  // pagination?: TablePaginationProps;
};

export const Table = <Entry extends Company>({
  data,
  columns,
  // pagination,
}: TableProps<Entry>) => {
